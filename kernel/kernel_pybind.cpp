...
array1d_t<int64_t> capsule_to_array1d_int(py::capsule& capsule) 
{
...
PYBIND11_MODULE(kernel, m) {
    ...
    m.def("gspmm",
        [](py::capsule & neber_index, py::capsule & neber, py::capsule & neber_value, py::capsule & w_value, py::capsule & output){
            array1d_t <int64_t> neber_index_array = capsule_to_array1d_int(neber_index);
            array1d_t <int64_t> neber_array = capsule_to_array1d_int(neber);
            array1d_t <float> neber_value_array = capsule_to_array1d(neber_value);
            array2d_t <float> w_value_array = capsule_to_array2d(w_value);
            array2d_t <float> output_array = capsule_to_array2d(output);
            invoke_spmm(neber_index_array, neber_array, neber_value_array, w_value_array, output_array);
            return true;
        }
    );
